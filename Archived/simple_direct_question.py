...
question = '我想要联系广州发展集团股份有限公司公司的法人代表，请问他的名字是什么？'
...
tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "根据提供的'公司名称'，查询该公司的'注册信息'。包括公司名称、登记状态、统一社会信用代码、注册资本、成立日期、省份、城市、区县、注册号、组织机构代码、参保人数、企业类型、曾用名。",
            "parameters": {
                "type": "object",
                "properties": {
                    "company_name": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "根据'法律文书某个字段'是'某个值'来查询具体的'案号'。法律文书字段包括标题、案号、文书类型、原告、被告、原告律师、被告律师、案由、审理法条依据、涉案金额、判决结果、胜诉方、文件名。",
            "parameters": {
                "type": "object",
                "properties": {
                    "key": {
